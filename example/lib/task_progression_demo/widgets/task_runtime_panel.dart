...
class TaskRuntimePanel extends StatelessWidget {
  final TaskProgressionDemoState state;

  const TaskRuntimePanel({
    super.key,
    required this.state,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return SectionCard(
      ...
      subtitle:
      'Current adaptive state and latest deterministic runtime decision produced for the task progression scenario.',
      child: viewData == null
          ? Text(
