...
class TaskTracePanel extends StatelessWidget {
  final TaskProgressionDemoState state;

  const TaskTracePanel({
    super.key,
    required this.state,
  });
    ...
    return Column(
      children: [
        DecisionTraceCard(
          ...
          emptyMessage: 'No task progression decision trace available yet.',
        ),
        ...
        ExecutionTraceView(
          ...
          subtitle:
          'Formatted runtime trace output for developer-facing inspection in the task progression scenario.',
        ),
      ],
    );
  }
